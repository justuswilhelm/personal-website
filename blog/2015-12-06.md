...
Very interesting. First, for every 3 female employees there are 5 male
...
which came up with 0.82 female-to-male pay ratio. That means that for every USD
...
histograms](http://www.justus.pw/blog/2015-11-30-Byte%20Histogram%20in%20Python%203.html).
...
```
[('Office Services Coordinator', 6.088682991396426),
 ('Police Officer III', 5.890138980807412),
 ('Community Health Nurse II', 4.500330906684315),
 ('Income Assistance Program Specialist II', 4.169424222369292),
 ('Manager III', 4.1363335539377895),
 ('Principal Administrative Aide', 3.805426869622766),
 ('Bus Operator', 3.540701522170748),
 ('Social Worker III', 2.7796161482461947),
 ('Public Safety Communications Specialist III', 2.4487094639311717),
 ('Social Worker II', 2.316346790205162)]
[('Police Officer III', 13.44312523937189),
 ('Firefighter/Rescuer III', 12.600536193029491),
 ('Bus Operator', 9.555725775564918),
 ('Master Firefighter/Rescuer', 3.810800459594025),
 ('Correctional Officer III (Corporal)', 3.5044044427422443),
 ('Fire/Rescue Captain', 2.5660666411336654),
 ('Police Sergeant', 2.3745691306013024),
 ('Mechanic Technician II', 2.297970126388357),
 ('Manager III', 2.278820375335121),
```

Now we can find out what percentage of employees for both genders are covered by
the 10 most common position titles.

```
The 10 most common position titles for female employees cover 39.68 of all employees
The 10 most common position titles for male employees cover 54.40 of all employees
```
...
compared to women? This is something which I cannot answer at the moment.
